...
public class newre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newre);
        ...
        upref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(n)) {
                    u = dataSnapshot.child(n).getValue(Member.class);
                    if (pw1.equals(dataSnapshot.child(n).child("password").getValue().toString())){
                        DatabaseReference  upref1 = FirebaseDatabase.getInstance().getReference().child("Member");
                        upref1.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if(dataSnapshot.hasChild(n)){
                                  ...
                                  //  if(!pw2.equals(null) && !pw3.equals(null)){
                                    ...
                                    System.out.println("lakaaaaaaaaaaaa"+n);
                            ...
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                Toast.makeText(getApplicationContext(), "Password updated successfully111", Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                b2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent ip=new Intent(newre.this,veiw.class);
                        startActivity(ip);
                    }
                });
